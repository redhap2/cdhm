...
eststo t29_3: xi: xtivreg2 log1_domestic7 (ratio_15_19_t = L15_netfertility5) L_ln_gdppc L_vargdppc L_log1_domestic7    i.year  if  inrange(year, 1950, 2018), fe  cluster(ccode)
estadd scalar kp_fstat = e(rkf)
